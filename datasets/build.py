...
from utils import eval_str, to_list, extend_list, add_path_option, Registry
...
def options(parser=None):
    ...
    group.add_argument('--dataset', default=None, type=eval_str,
                       help='The datasets use in train/eval/test. '
                            ...
                            f'Default datasets: {list(NERF_DATASETS.keys())}'
                       )
    ...
    utils.add_cfg_option(group, "--dataset-cfg", default={}, help="The common configure for all datasets")
