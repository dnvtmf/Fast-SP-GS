...
__all__ = ['default_collate', 'iterable_collate', 'first_collate', 'DATA_COLLATOR']
DATA_COLLATOR = Registry()

T_fn_map = Optional[Dict[Union[Type, Tuple[Type, ...]], Callable]]

default_collate_fn_map[type(None)] = lambda *args, **kwargs: None
DATA_COLLATOR['default'] = default_collate
...
@DATA_COLLATOR.register('iterable')
